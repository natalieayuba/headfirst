...
const Confirmation = ({
  ...
  return (
    ...
    >
      ...
      <ButtonLink href='#'>View tickets</ButtonLink>
      <p className='mt-auto secondary-text'>
        You have just helped the Bristol music scene. Thanks for choosing a
        local ticket outlet and helping us support Bristol’s independent and
        underground venues.
      </p>
    </div>
  );
