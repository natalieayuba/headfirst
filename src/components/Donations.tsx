...
const Donations = () => {
  return (
    <HomeSection heading='Join us in supporting local causes'>
      <div className='w-full h-auto aspect-[1.9] bg-night text-lilac rounded-lg flex flex-col p-6 gap-3 items-center justify-center'>
        <Icon name='clap' size={32} />
        <p className='heading-lg'>
          <span className='font-sans font-extrabold text-3xl'>£</span>14,177.50
        </p>
